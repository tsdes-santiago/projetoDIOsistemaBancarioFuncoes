...
def operar_conta():
    ...
    if conta:
        # Encontra o usuário e obtém dados de saldo e limite
        cpf = conta['cpf']
        usuario = filtrar_usuario(cpf, lista_usuarios)
        nome = usuario['nome']
...
# Criando um usuário com saldo para acessar conta
usuario_1 = {'nome':'José João', 'nascimento':'01-01-1991', 'cpf':'123456789', 
             'endereço':'Rua dos Bobos, 0 - bairro - cidade/NA'}
